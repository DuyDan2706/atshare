  ...
  const formik = useFormik<contractgroupModel>({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        const rentFrom = dayjs(values.rentFrom).locale('en').add(1, 'day');;
        const rentTo = dayjs(values.rentTo).locale('en').add(1, 'day');;
        const actionAsyncLogin = postCarContractgroupReducercarAsyncApi({
          ...
          customerCitizenIdentificationInfoDate:
            dateCMNDAlready == null
              ...
              : dateCMNDAlready,
          carId: 0,
          rentFrom: rentFrom.toDate(),
          rentTo: rentTo.toDate(),
        });
